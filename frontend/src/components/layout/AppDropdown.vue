<template>
  <div class="dropdown-wrapper" ref="dropdownRef">
    <input class="dropdown-input" :placeholder="placeholder" v-model="searchQuery" @focus="isOpen = true" />

    <div class="dropdown-content" v-show="isOpen">
      <ul class="options-list">
        <li v-for="item in filteredItems" :key="item.id" class="option-item" @click.stop="handleItemClick(item)">
